...
fr['gui.panel.generation.distortion'] = `déformation des cellules`
fr['gui.panel.generation.gradient'] = `dégradé des frontières`
fr['gui.panel.generation.poissonDensity'] = `densité de points`
...
fr['gui.panel.rendering.scale'] = `échelle des sprites`
fr['gui.panel.rendering.voronoiColor'] = `couleur de la grille`
fr['gui.panel.rendering.backgroundColor'] = `couleur de l'arrière-plan`
fr['gui.panel.rendering.backgroundAlpha'] = `transparence de l'arrière-plan`

fr['gui.panel.legend'] = `légende`
fr['gui.panel.legend.DESERT'] = `désert [DESERT]`
fr['gui.panel.legend.FOREST'] = `forêt [FOREST]`
...
fr['gui.panel.view'] = `échelle`
fr['gui.panel.view.canvasScale'] = `échelle du canvas`
